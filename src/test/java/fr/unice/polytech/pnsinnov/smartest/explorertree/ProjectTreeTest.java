...
class ProjectTreeTest {
    ...
    private ProjectTree module;

    @BeforeEach
    public void setup(){
        module = new ProjectTree.TreeModuleBuilder().withProjectBase(Paths.get("").toAbsolutePath().toString()).withPlugin(PluginEnum.MAVEN.getAssociatedPlugin()).build();
    }
